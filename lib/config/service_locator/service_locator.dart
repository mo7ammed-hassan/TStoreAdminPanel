...
import 'package:t_store_admin_panel/data/repositories/orders/order_repository_impl.dart';
...
import 'package:t_store_admin_panel/features/authentiacation/cubits/sign_in/sign_in_cubit.dart';
...
void setupServiceLocator() {
  ...
  /// ----Media----
  // Firebase Services
  getIt.registerFactory<MediaFirebaseServices>(
  ...
  getIt.registerFactory<CreateBrandCubit>(
    () => CreateBrandCubit(getIt<BrandRepo>()),
  );
  ...
  getIt.registerLazySingleton<GenericRepository<ProductModel>>(
    () => getIt<ProductRepoImpl>(),
  );
  getIt.registerFactory<ProductCubit>(
    () => ProductCubit(getIt<GenericRepository<ProductModel>>()),
  );
  getIt.registerFactory<CreateProductCubit>(() => CreateProductCubit());

  ///----------------------------------------------------------------///
  /// ---- Orders ----
  /// Firebase Services
  getIt.registerLazySingleton<OrderFirebaseServices>(
    () => OrderFirebaseServicesImpl(),
  );

  getIt.registerLazySingleton<OrderRepository>(
    () => OrderRepositoryImpl(getIt<OrderFirebaseServices>()),
  );
  ...
  getIt.registerLazySingleton<GenericFirebaseServices<UserModel>>(
    () => GenericFirebaseServicesImpl<UserModel>(
      FirebaseCollections.users,
      (json, [id]) => UserModel.fromJson(json, id),
      (user) => user.toJson(),
    ),
  );
  
  getIt.registerLazySingleton<GenericRepository<UserModel>>(
    () => GenericRepositoryImpl<UserModel>(
      getIt<GenericFirebaseServices<UserModel>>(),
    ),
  );

  /// Firebase Services
  getIt.registerFactory<CustomerCubit>(
    () => CustomerCubit(getIt<GenericRepository<UserModel>>()),
  );
}
