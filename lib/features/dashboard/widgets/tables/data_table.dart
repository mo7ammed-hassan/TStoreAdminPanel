...
import 'package:t_store_admin_panel/features/dashboard/widgets/tables/order_data_table_source.dart';
...
class DashboardOrdersTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomPaginatedTable(
      ...
      source: RecentOrderDataTable(dashboardCubit: context.read<DashboardCubit>()),
    );
  }
}
