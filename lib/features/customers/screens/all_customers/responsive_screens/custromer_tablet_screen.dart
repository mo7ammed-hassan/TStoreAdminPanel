...
import 'package:t_store_admin_panel/features/customers/screens/all_customers/table/data_table.dart';

class CustromerTabletScreen extends StatelessWidget {
  const CustromerTabletScreen({super.key});
