...
import 'package:t_store_admin_panel/core/utils/loaders/upload_image_loader.dart';
...
import 'package:t_store_admin_panel/features/media/widget/drag_and_drop_area/build_drag_and_drop_area.dart';
import 'package:t_store_admin_panel/features/media/widget/media_uploader/selected_image_section/selected_images_section.dart';
          ...
          (context) => AlertDialog(
            backgroundColor:
                HelperFunctions.isDarkMode(context)
                    ...
                    : AppColors.white,
            title: Text(
              '${getIt<UserCubit>().userData.userName} !!',
