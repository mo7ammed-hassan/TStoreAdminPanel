...
import 'package:t_store_admin_panel/features/media/widget/drag_and_drop_area/drag_and_drop_area.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: Column(
        ...
        children: [
          Image.asset(AppImages.defaultImage, width: 50, height: 50),
