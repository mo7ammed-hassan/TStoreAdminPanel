...
class MediaCubit extends Cubit<MediaState> {
  ...
  void removeSelectedImage(String imageUrl) {
    selectedImagesToUpload.removeWhere((image) => image.fileName == imageUrl);
    emit(SelectedImagesLoadedState());
  }
  ...
  // remove iage from multi selection
  void removeImageFromMultiSelection(String imageUrl) {
    selectedImagesToUpload.removeWhere(
      (image) => image.url.toLowerCase() == imageUrl.toLowerCase(),
    );
    emit(SelectedImagesLoadedState());
  }
}
