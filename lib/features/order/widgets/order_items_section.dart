...
import 'package:t_store_admin_panel/core/utils/helpers/pricing_calculator.dart';
        ...
        children: [
          ...
          ListView.separated(
            ...
            itemBuilder: (context, index) {
              final orderItem = order.cartItems?[index] ?? CartItemModel();
              return Row(
                children: [
                  Expanded(
                    child: Row(
                        ...
                        TRoundedImage(
                          imageType:
                              orderItem.productImage != null
                                  ...
                                  : ImageType.asset,
                          image:
                              orderItem.productImage ?? AppImages.defaultImage,
                        ),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      '\$${TPricingCalculator.calculateShippingCost(subTotal ?? 0, '')}', // shippingCost
                      style: Theme.of(context).textTheme.titleLarge,
                    ),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      '\$${TPricingCalculator.calculateTax(subTotal ?? 0, '')}', //taxRateCost
                      style: Theme.of(context).textTheme.titleLarge,
                    ),
                  ],
                ),
