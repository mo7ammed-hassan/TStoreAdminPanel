...
import 'package:t_store_admin_panel/features/brands/screens/edit_brands/responsive_screens/widgets/edit_categories_section.dart';
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              UploaderImage<EditBrandCubit, EditBrandStates>(
                width: 80,
                height: 80,
                imageSelector:
                    (state) =>
              ...
              ToggleCheckboxMenuButton<EditBrandCubit, EditBrandStates>(
                selector:
                    (state) =>
