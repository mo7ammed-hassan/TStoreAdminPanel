...
import 'package:t_store_admin_panel/features/products/screens/all_products/table/table_source.dart';
      ...
      builder: (context, state) {
        ...
        if (state is ProductsLoadedState) {
          return CustomPaginatedTable(
            ...
            source: ProductRows(state.products, cubit, context),
          );
        }
