                  ...
                  builder: (context, state) {
                    ...
                    if (state is UserLoadedState) {
                      return RoundedImage(
                        ...
                        showShadow: false,
                        imageUrl:
                            (userCubit.userData.userProfilePicture != null &&
                                    userCubit
                                        .userData
                                        .userProfilePicture!
                                        .isNotEmpty)
                                ? userCubit.userData.userProfilePicture!
                                : AppImages.user,
                        isNetworkImage:
                            (userCubit.userData.userProfilePicture != null &&
                                    userCubit
                    ...
                    builder: (context, state) {
                      ...
                      if (state is UserLoadedState) {
                        return Column(
                          ...
                          children: [
                            Text(
                              getIt<UserCubit>().userData.userFullName ?? '',
                              style: Theme.of(context).textTheme.titleLarge,
                            ),
                            Text(
                              getIt<UserCubit>().userData.userEmail,
