...
extension NavigationX on BuildContext {
  ...
  void popPage(BuildContext context , {Object? result}) {
    Navigator.pop(context, result); // remove the current page from memory
  }
  ...
  void pushNamedAndRemoveUntilPage(String route) =>
